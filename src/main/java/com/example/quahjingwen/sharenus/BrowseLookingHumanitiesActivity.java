...
public class BrowseLookingHumanitiesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_browse_looking_humanities);
        ...
        dref.orderByChild("eCourse").equalTo("Humanities").addChildEventListener(new ChildEventListener() {
            @Override
