...
public class BrowseLookingAsianStudies extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_browse_looking_asianstudies);

        mclick2chat = findViewById(R.id.click2chatt);
        ...
        mclick2chat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(BrowseLookingAsianStudies.this, UsersActivity.class);
                startActivity(intent);
            }
        });


        dref.orderByChild("eCourse").equalTo("Asian Studies").addChildEventListener(new ChildEventListener() {
            @Override
