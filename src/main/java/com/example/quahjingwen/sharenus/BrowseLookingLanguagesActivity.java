...
public class BrowseLookingLanguagesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_browse_looking_languages);
        ...
        dref.orderByChild("eCourse").equalTo("Languages").addChildEventListener(new ChildEventListener() {
            @Override
