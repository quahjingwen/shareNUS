...
public class UploadSellingActivity extends AppCompatActivity implements View.OnClickListener /*  implementing click listener */ {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonUpload = (Button) findViewById(R.id.buttonUploadS);
        buttonDone = (Button) findViewById(R.id.doneS);

        imageView = (ImageView) findViewById(R.id.imageViewS);
        ImageName = findViewById(R.id.ImageNameS);
        eFaculty = findViewById(R.id.FacultyS);
        eCourse = findViewById(R.id.CourseS);
        eModuleCode = findViewById(R.id.ModuleCodeS);
        eDescription = findViewById(R.id.DescriptionS);
        eUsername = findViewById(R.id.UsernameS);
        ...
        // Root Database Name for Firebase Database.
        Database_Path = "Selling_Database";
    ...
    public void onClick(View view) {
        ...
        //if the clicked button is upload
            ...
            Intent intent = new Intent(UploadSellingActivity.this, BrowseSellingActivity.class);
